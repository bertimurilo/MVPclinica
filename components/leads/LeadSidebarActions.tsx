    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <select
          ...
          disabled={isPending}
          className="w-full bg-gray-900 border border-gray-700 text-white rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-500 transition-all disabled:opacity-50"
        >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full bg-gray-900 border border-gray-700 text-white rounded-lg px-3 py-2 text-sm placeholder:text-gray-600 outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-500 transition-all resize-none"
        />
        <button
          onClick={handleSaveNotes}
          disabled={isPending}
          className={`mt-1 text-xs transition-colors disabled:opacity-40 ${
            notesStatus === 'saved' ? 'text-violet-400' :
